import"../chunks/DsnmJJEf.js";import{al as b,$ as f,a1 as C,a0 as p,t as M,K as c,an as F,Z,ag as J,_ as K,ad as ie,M as R,aE as ke,am as P,ba as Ae,L as Se}from"../chunks/BouHPhyx.js";import{b as h,f as _,c as D,t as Ce}from"../chunks/CjYGnkC0.js";import{a as E,f as xe,e as de}from"../chunks/BA0teXdn.js";import{e as U,i as N,b as Ie,s as ue,c as Ee,d as De}from"../chunks/BJ9YyB53.js";import{e as oe}from"../chunks/CPwCmilQ.js";import{c as se}from"../chunks/BYrJ3R8_.js";import{s as re,p as q}from"../chunks/BedyKmqI.js";import{s as me}from"../chunks/Bnz2TgY4.js";import{b as Me,i as ee}from"../chunks/Rb_QLIf0.js";import{c as Oe}from"../chunks/QBsKloMc.js";import{h as z}from"../chunks/BIxuo7In.js";import{b as Be}from"../chunks/PSmCoOTc.js";import"../chunks/tGppMfpQ.js";var he={},te={},ae=34,Y=10,ne=13;function ge(n){return new Function("d","return {"+n.map(function(e,t){return JSON.stringify(e)+": d["+t+'] || ""'}).join(",")+"}")}function Le(n,e){var t=ge(n);return function(o,s){return e(t(o),s,n)}}function pe(n){var e=Object.create(null),t=[];return n.forEach(function(o){for(var s in o)s in e||t.push(e[s]=s)}),t}function I(n,e){var t=n+"",o=t.length;return o<e?new Array(e-o+1).join(0)+t:t}function je(n){return n<0?"-"+I(-n,6):n>9999?"+"+I(n,6):I(n,4)}function qe(n){var e=n.getUTCHours(),t=n.getUTCMinutes(),o=n.getUTCSeconds(),s=n.getUTCMilliseconds();return isNaN(n)?"Invalid Date":je(n.getUTCFullYear())+"-"+I(n.getUTCMonth()+1,2)+"-"+I(n.getUTCDate(),2)+(s?"T"+I(e,2)+":"+I(t,2)+":"+I(o,2)+"."+I(s,3)+"Z":o?"T"+I(e,2)+":"+I(t,2)+":"+I(o,2)+"Z":t||e?"T"+I(e,2)+":"+I(t,2)+"Z":"")}function Fe(n){var e=new RegExp('["'+n+`
\r]`),t=n.charCodeAt(0);function o(a,d){var T,w,m=s(a,function(S,v){if(T)return T(S,v-1);w=S,T=d?Le(S,d):ge(S)});return m.columns=w||[],m}function s(a,d){var T=[],w=a.length,m=0,S=0,v,k=w<=0,A=!1;a.charCodeAt(w-1)===Y&&--w,a.charCodeAt(w-1)===ne&&--w;function j(){if(k)return te;if(A)return A=!1,he;var G,W=m,x;if(a.charCodeAt(W)===ae){for(;m++<w&&a.charCodeAt(m)!==ae||a.charCodeAt(++m)===ae;);return(G=m)>=w?k=!0:(x=a.charCodeAt(m++))===Y?A=!0:x===ne&&(A=!0,a.charCodeAt(m)===Y&&++m),a.slice(W+1,G-1).replace(/""/g,'"')}for(;m<w;){if((x=a.charCodeAt(G=m++))===Y)A=!0;else if(x===ne)A=!0,a.charCodeAt(m)===Y&&++m;else if(x!==t)continue;return a.slice(W,G)}return k=!0,a.slice(W,w)}for(;(v=j())!==te;){for(var L=[];v!==he&&v!==te;)L.push(v),v=j();d&&(L=d(L,S++))==null||T.push(L)}return T}function r(a,d){return a.map(function(T){return d.map(function(w){return i(T[w])}).join(n)})}function u(a,d){return d==null&&(d=pe(a)),[d.map(i).join(n)].concat(r(a,d)).join(`
`)}function g(a,d){return d==null&&(d=pe(a)),r(a,d).join(`
`)}function y(a){return a.map(l).join(`
`)}function l(a){return a.map(i).join(n)}function i(a){return a==null?"":a instanceof Date?qe(a):e.test(a+="")?'"'+a.replace(/"/g,'""')+'"':a}return{parse:o,parseRows:s,format:u,formatBody:g,formatRows:y,formatRow:l,formatValue:i}}var Re=Fe(","),Ue=Re.parse,Ne=_('<section id="demo-link"><h2>Link</h2> <p><a href="elements">Default element styles demo</a></p> <p><a href="fonts">Pudding-hosted font previews</a></p> <p><a href="ui">BitsUI styled components</a></p></section>');function He(n){var e=Ne();h(n,e)}var Pe=_('<section id="demo-image"><h2>Image</h2> <p>img tag</p> <img src="../assets/demo/test.jpg" alt="cat" class="svelte-b56t42"/> <p>background image</p> <div class="svelte-b56t42"></div></section>');function Ge(n){var e=Pe();h(n,e)}var We=_('<section id="demo-element"><h2>Dynamic Svelte Element</h2> <!></section>');function ze(n){const e=[{tag:"h3",text:"I am a h3 tag."},{tag:"p",text:"I am p tag."}];var t=We(),o=b(f(t),2);U(o,17,()=>e,N,(s,r)=>{let u=()=>c(r).tag,g=()=>c(r).text;var y=D(),l=C(y);oe(l,u,!1,(i,a)=>{var d=Ce();M(()=>E(d,g())),h(a,d)}),h(s,y)}),p(t),h(n,t)}var Ve=_("<p> </p>");function Ye(n,e){var t=Ve(),o=f(t);p(t),M(()=>E(o,`I am component A and my favorite number is ${e.number??""}.`)),h(n,t)}var Je=_("<p> </p>");function Ze(n,e){var t=Je(),o=f(t);p(t),M(()=>E(o,`I am component B and my name is ${e.name??""}.`)),h(n,t)}var Ke=_('<section id="demo-component"><h2>Dynamic Svelte Component</h2> <!></section>');function Qe(n){const e={A:Ye,B:Ze},t=[{component:"A",number:42},{component:"B",name:"Russell"}];var o=Ke(),s=b(f(o),2);U(s,17,()=>t,N,(r,u)=>{const g=F(()=>e[c(u).component]);var y=D(),l=C(y);se(l,()=>c(g),(i,a)=>{a(i,re(()=>c(u)))}),h(r,y)}),p(o),h(n,o)}var Xe=_("<div><!></div>");function $e(n,e){Z(e,!0);let t=q(e,"root",3,null),o=q(e,"top",3,0),s=q(e,"bottom",3,0),r=q(e,"increments",3,100),u=q(e,"value",15,void 0),g=[],y=[],l=[],i=[],a;function d(){let v=0,k=0;for(let A=0;A<g.length;A++)g[A]>v&&(v=g[A],k=A);v>0?u(k):u(void 0)}function T(v,k){const A=H=>{H[0].isIntersecting;const Q=H[0].intersectionRatio;g[k]=Q,d()},j=o()?o()*-1:0,L=s()?s()*-1:0,G=`${j}px 0px ${L}px 0px`,W={root:t(),rootMargin:G,threshold:y};i[k]&&i[k].disconnect();const x=new IntersectionObserver(A,W);x.observe(v),i[k]=x}function w(){l.length&&l.forEach(T)}J(()=>{for(let v=0;v<r()+1;v++)y.push(v/r());l=a.querySelectorAll(":scope > *:not(iframe)"),w()}),J(()=>{o(),s(),w()});var m=Xe(),S=f(m);me(S,()=>e.children??ie),p(m),Me(m,v=>a=v,()=>a),h(n,m),K()}var et=_('<div><p class="svelte-1sxgmm9"> </p></div>'),tt=_('<section id="scrolly"><h2 class="svelte-1sxgmm9">Scrolly <span> </span></h2> <div class="spacer svelte-1sxgmm9"></div> <!> <div class="spacer svelte-1sxgmm9"></div></section>');function at(n){let e=P(void 0);var t=tt(),o=f(t),s=b(f(o)),r=f(s,!0);p(s),p(o);var u=b(o,4);$e(u,{get value(){return c(e)},set value(g){R(e,g,!0)},children:(g,y)=>{var l=D(),i=C(l);U(i,16,()=>[0,1,2,3,4],N,(a,d,T)=>{const w=F(()=>c(e)===T);var m=et();let S;var v=f(m),k=f(v,!0);p(v),p(m),M(()=>{S=Ie(m,1,"step svelte-1sxgmm9",null,S,{active:c(w)}),E(k,d)}),h(a,m)}),h(g,l)},$$slots:{default:!0}}),ke(2),p(t),M(()=>E(r,c(e)||"-")),h(n,t)}const nt=`{
  "meta": {
  ...
  "story": [
    ...
    },
    {
      ...
      "note": "Data source: all words run through the UCREL Semantic Analysis System (USAS), then grouped into five top categories: <ol class=note-list> <li class=note-list-item>The Self: Emotion | The Body and the Individual</li> <li class=note-list-item>Local/Immediate: Substances, Materials, Objects and Equipment | Food and Farming | Life and Living Things | Architecture, Housing and the Home | World and Environment</li> <li class=note-list-item>Institutional: Money and Commerce in Industry | Government and Public | Education | Science and Technology</li> <li class=note-list-item>Social/Communicative: Social Actions, States, and Processes | Movement, Location, Travel and Transport | Language and Communication | Entertainment, Sports and Games</li> <li class=note-list-item>Universal/Abstract: General and Abstract Terms | Psychological Actions, States and Processes | Numbers and Measurement | Names and Grammar | Time | Arts and Crafts</li> </ol>",
      "overlays": [
        {
...
}`;var ot=_("<p></p>"),st=_('<details><summary></summary> <div class="content"><!></div></details>');function rt(n,e){let t=F(()=>typeof e.content=="string"),o=F(()=>e.open==="true");var s=st(),r=f(s);z(r,()=>e.summary,!0),p(r);var u=b(r,2),g=f(u);{var y=i=>{var a=D(),d=C(a);z(d,()=>e.content),h(i,a)},l=i=>{var a=D(),d=C(a);U(d,17,()=>e.content,N,(T,w)=>{let m=()=>c(w).value;var S=ot();z(S,m,!0),p(S),h(T,S)}),h(i,a)};ee(g,i=>{c(t)?i(y):i(l,-1)})}p(u),p(s),M(()=>{s.open=c(o),ue(s,"name",e.name)}),h(n,s)}var it=_("<li></li>"),lt=_("<ul></ul>");function ct(n,e){var t=lt();U(t,21,()=>e.li,N,(o,s)=>{var r=it();z(r,()=>c(s),!0),p(r),h(o,r)}),p(t),h(n,t)}var dt=_("<li></li>"),ht=_("<ol></ol>");function pt(n,e){var t=ht();U(t,21,()=>e.li,N,(o,s)=>{var r=dt();z(r,()=>c(s),!0),p(r),h(o,r)}),p(t),h(n,t)}var ut=_("<p></p>"),mt=_("<section><!></section>");function gt(n,e){Z(e,!0);const t={details:rt,ul:ct,ol:pt};let o=q(e,"components",19,()=>({})),s=q(e,"body",19,()=>[]);var r=D(),u=C(r);U(u,17,s,N,(g,y)=>{let l=()=>c(y).section,i=()=>c(y).content;const a=F(()=>l().toLowerCase().replace(/[^a-z0-9]/g,"")),d=F(()=>o()[l()]);var T=mt(),w=f(T);{var m=v=>{var k=D(),A=C(k);se(A,()=>c(d),(j,L)=>{L(j,re(i))}),h(v,k)},S=v=>{var k=D(),A=C(k);U(A,17,i,N,(j,L,G,W)=>{let x=()=>c(L).type,H=()=>c(L).value;const Q=F(()=>o()[x()]||t[x()]),ve=F(()=>typeof H()=="string");var le=D(),fe=C(le);{var ye=O=>{var B=D(),V=C(B);se(V,()=>c(Q),(X,$)=>{$(X,re(H))}),h(O,B)},we=O=>{var B=ut();z(B,H,!0),p(B),h(O,B)},be=O=>{var B=D(),V=C(B);oe(V,x,!1,(X,$)=>{var ce=D(),Te=C(ce);z(Te,H),h($,ce)}),h(O,B)},_e=O=>{var B=D(),V=C(B);oe(V,x,!1,(X,$)=>{Ee(X,()=>({...H()}))}),h(O,B)};ee(fe,O=>{c(Q)?O(ye):x()==="text"?O(we,1):c(ve)?O(be,2):O(_e,-1)})}h(j,le)}),h(v,k)};ee(w,v=>{c(d)?v(m):v(S,-1)})}p(T),M(()=>ue(T,"id",c(a))),h(g,T)}),h(n,r),K()}var vt=_('<p> </p> <progress max="100"></progress>',1);function ft(n,e){let t=q(e,"label",3,"A"),o=q(e,"value",3,0);var s=vt(),r=C(s),u=f(r,!0);p(r);var g=b(r,2);M(()=>{E(u,t()),De(g,o())}),h(n,s)}var yt=_('<section id="cms"><h2>MicroCMS</h2> <code><pre> </pre></code> <!></section>');function wt(n,e){Z(e,!0);const{body:t}=Oe,o={Test:ft};var s=yt(),r=b(f(s),2),u=f(r),g=f(u,!0);p(u),p(r);var y=b(r,2);gt(y,{get components(){return o},get body(){return t}}),p(s),M(l=>E(g,l),[()=>nt.replace(/\t/g," ")]),h(n,s),K()}const bt=(n,e=ie)=>{var t=_t(),o=f(t),s=f(o,!0);p(o);var r=b(o,2),u=f(r,!0);p(r),p(t),M(()=>{E(s,e().name),E(u,e().age)}),h(n,t)};var _t=_('<div class="person svelte-q3gttf"><p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p></div>'),Tt=_('<h2>Svelte5</h2> <h3>Reactive variables 3 ways:</h3> <button class="svelte-q3gttf">count++</button> <p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p> <h3>Children (previously slots):</h3> <div class="children"><!></div> <h3>Dispatch Event</h3> <button class="svelte-q3gttf">Random</button>  <h3>Snippets</h3> <div class="people svelte-q3gttf"></div>',1);function kt(n,e){Z(e,!0),q(e,"age",3,30);const t=[{name:"John",age:30},{name:"Jill",age:45}];let o=P(0),s=F(()=>c(o)*2),r=F(()=>c(o)*2),u=P(0);J(()=>{R(u,c(o)*2)});var g=Tt(),y=b(C(g),4),l=b(y,2),i=f(l);p(l);var a=b(l,2),d=f(a);p(a);var T=b(a,2),w=f(T);p(T);var m=b(T,4),S=f(m);me(S,()=>e.children??ie),p(m);var v=b(m,4),k=b(v,4);U(k,21,()=>t,N,(A,j)=>{bt(A,()=>c(j))}),p(k),M(()=>{E(i,`${c(o)??""} doubled is ${c(s)??""} (derived)`),E(d,`${c(o)??""} doubled is ${c(r)??""} (derived by)`),E(w,`${c(o)??""} doubled is ${c(u)??""} ($effect)`)}),de("click",y,()=>Ae(o)),de("click",v,()=>e.random(Math.floor(Math.random()*10))),h(n,g),K()}xe(["click"]);const At=(n,e)=>{let t=P(Se(n)),o=P(null),s=P(!0),r=P(void 0);const u=(l=!0)=>{R(s,l,!0),l===!0&&(R(r,null),R(o,null))},g=async()=>{try{const l=await fetch(c(t),e);if(!l.ok)throw new Error(`Unexpected error occurred (status ${l.status})`);let i;if(c(t).includes(".csv")){const a=await l.text();i=Ue(a)}else i=await l.json();return[null,i]}catch(l){const{errorMessage:i="Unexpected error eccurred"}=l;return[i,null]}},y=async l=>{u(!0);const[i,a]=await g();if(l===c(t)){if(i){u(!1),R(r,i,!0);return}u(!1),R(o,a,!0)}};return J(()=>{y(c(t))}),{get data(){return c(o)},get loading(){return c(s)},get error(){return c(r)},get url(){return c(t)},set url(l){c(t)!==l&&R(t,l,!0)}}};var St=_("<p>loading data...</p>"),Ct=_("<p> </p>"),xt=_("<p>data loaded</p> <pre> </pre>",1),It=_('<div class="c"><h2>Load Data</h2> <div class="response"><!></div></div>');function Et(n,e){Z(e,!0);const t=`${Be}/assets/demo/test.csv`,o=At(t);J(()=>{});var s=It(),r=b(f(s),2),u=f(r);{var g=i=>{var a=St();h(i,a)},y=i=>{var a=Ct(),d=f(a);p(a),M(()=>E(d,`error: ${o.error??""}`)),h(i,a)},l=i=>{var a=xt(),d=b(C(a),2),T=f(d,!0);p(d),M(w=>E(T,w),[()=>JSON.stringify(o.data,null,2)]),h(i,a)};ee(u,i=>{o.loading?i(g):o.error?i(y,1):i(l,-1)})}p(r),p(s),h(n,s),K()}var Dt=_('<div id="demo" class="svelte-15aotx7"><h1>Demo</h1> <!> <!> <!> <!> <!> <!> <!> <!></div>');function Mt(n){let e=P(0);function t(d){console.log(d)}var o=Dt(),s=b(f(o),2);He(s);var r=b(s,2);Ge(r);var u=b(r,2);ze(u);var g=b(u,2);Qe(g);var y=b(g,2);wt(y,{});var l=b(y,2);Et(l,{});var i=b(l,2);at(i);var a=b(i,2);kt(a,{random:t,get value(){return c(e)},set value(d){R(e,d,!0)}}),p(o),h(n,o)}function Vt(n){Mt(n)}export{Vt as component};
