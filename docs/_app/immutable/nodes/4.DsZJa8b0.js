import"../chunks/DsnmJJEf.js";import{al as b,$ as v,a1 as C,a0 as p,t as B,K as c,an as j,Z as Y,ag as V,_ as Z,ad as ie,M as q,aE as ke,am as W,ba as Te,L as Ae}from"../chunks/Bs3EBm-E.js";import{b as h,f as _,c as E,t as Ce}from"../chunks/D2Oxhlm5.js";import{a as I,f as Le,e as de}from"../chunks/4YDsmxP6.js";import{e as F,i as U,b as xe,s as ue,c as Ie,d as Ee}from"../chunks/De1QSCgL.js";import{e as se}from"../chunks/Bx3wK1xy.js";import{c as oe}from"../chunks/BkLDZTjO.js";import{s as re,p as O}from"../chunks/CSD_HoJp.js";import{s as me}from"../chunks/NZYRv9zf.js";import{b as Be,i as ee}from"../chunks/DJmFeHHs.js";import{c as Me}from"../chunks/DuBEZ759.js";import{h as z}from"../chunks/l0FKtB1Q.js";import{b as De}from"../chunks/D2nTKms0.js";import"../chunks/DyXMOwH3.js";var he={},ae={},te=34,K=10,ne=13;function ge(n){return new Function("d","return {"+n.map(function(e,a){return JSON.stringify(e)+": d["+a+'] || ""'}).join(",")+"}")}function Ne(n,e){var a=ge(n);return function(s,o){return e(a(s),o,n)}}function pe(n){var e=Object.create(null),a=[];return n.forEach(function(s){for(var o in s)o in e||a.push(e[o]=o)}),a}function x(n,e){var a=n+"",s=a.length;return s<e?new Array(e-s+1).join(0)+a:a}function Ge(n){return n<0?"-"+x(-n,6):n>9999?"+"+x(n,6):x(n,4)}function Oe(n){var e=n.getUTCHours(),a=n.getUTCMinutes(),s=n.getUTCSeconds(),o=n.getUTCMilliseconds();return isNaN(n)?"Invalid Date":Ge(n.getUTCFullYear())+"-"+x(n.getUTCMonth()+1,2)+"-"+x(n.getUTCDate(),2)+(o?"T"+x(e,2)+":"+x(a,2)+":"+x(s,2)+"."+x(o,3)+"Z":s?"T"+x(e,2)+":"+x(a,2)+":"+x(s,2)+"Z":a||e?"T"+x(e,2)+":"+x(a,2)+"Z":"")}function je(n){var e=new RegExp('["'+n+`
\r]`),a=n.charCodeAt(0);function s(t,d){var S,y,m=o(t,function(A,f){if(S)return S(A,f-1);y=A,S=d?Ne(A,d):ge(A)});return m.columns=y||[],m}function o(t,d){var S=[],y=t.length,m=0,A=0,f,k=y<=0,T=!1;t.charCodeAt(y-1)===K&&--y,t.charCodeAt(y-1)===ne&&--y;function G(){if(k)return ae;if(T)return T=!1,he;var P,H=m,L;if(t.charCodeAt(H)===te){for(;m++<y&&t.charCodeAt(m)!==te||t.charCodeAt(++m)===te;);return(P=m)>=y?k=!0:(L=t.charCodeAt(m++))===K?T=!0:L===ne&&(T=!0,t.charCodeAt(m)===K&&++m),t.slice(H+1,P-1).replace(/""/g,'"')}for(;m<y;){if((L=t.charCodeAt(P=m++))===K)T=!0;else if(L===ne)T=!0,t.charCodeAt(m)===K&&++m;else if(L!==a)continue;return t.slice(H,P)}return k=!0,t.slice(H,y)}for(;(f=G())!==ae;){for(var N=[];f!==he&&f!==ae;)N.push(f),f=G();d&&(N=d(N,A++))==null||S.push(N)}return S}function r(t,d){return t.map(function(S){return d.map(function(y){return i(S[y])}).join(n)})}function u(t,d){return d==null&&(d=pe(t)),[d.map(i).join(n)].concat(r(t,d)).join(`
`)}function g(t,d){return d==null&&(d=pe(t)),r(t,d).join(`
`)}function w(t){return t.map(l).join(`
`)}function l(t){return t.map(i).join(n)}function i(t){return t==null?"":t instanceof Date?Oe(t):e.test(t+="")?'"'+t.replace(/"/g,'""')+'"':t}return{parse:s,parseRows:o,format:u,formatBody:g,formatRows:w,formatRow:l,formatValue:i}}var qe=je(","),Fe=qe.parse,Ue=_('<section id="demo-link"><h2>Link</h2> <p><a href="elements">Default element styles demo</a></p> <p><a href="fonts">Pudding-hosted font previews</a></p> <p><a href="ui">BitsUI styled components</a></p></section>');function Re(n){var e=Ue();h(n,e)}var We=_('<section id="demo-image"><h2>Image</h2> <p>img tag</p> <img src="../assets/demo/test.jpg" alt="cat" class="svelte-b56t42"/> <p>background image</p> <div class="svelte-b56t42"></div></section>');function Pe(n){var e=We();h(n,e)}var He=_('<section id="demo-element"><h2>Dynamic Svelte Element</h2> <!></section>');function ze(n){const e=[{tag:"h3",text:"I am a h3 tag."},{tag:"p",text:"I am p tag."}];var a=He(),s=b(v(a),2);F(s,17,()=>e,U,(o,r)=>{let u=()=>c(r).tag,g=()=>c(r).text;var w=E(),l=C(w);se(l,u,!1,(i,t)=>{var d=Ce();B(()=>I(d,g())),h(t,d)}),h(o,w)}),p(a),h(n,a)}var Je=_("<p> </p>");function Ke(n,e){var a=Je(),s=v(a);p(a),B(()=>I(s,`I am component A and my favorite number is ${e.number??""}.`)),h(n,a)}var Ve=_("<p> </p>");function Ye(n,e){var a=Ve(),s=v(a);p(a),B(()=>I(s,`I am component B and my name is ${e.name??""}.`)),h(n,a)}var Ze=_('<section id="demo-component"><h2>Dynamic Svelte Component</h2> <!></section>');function Qe(n){const e={A:Ke,B:Ye},a=[{component:"A",number:42},{component:"B",name:"Russell"}];var s=Ze(),o=b(v(s),2);F(o,17,()=>a,U,(r,u)=>{const g=j(()=>e[c(u).component]);var w=E(),l=C(w);oe(l,()=>c(g),(i,t)=>{t(i,re(()=>c(u)))}),h(r,w)}),p(s),h(n,s)}var Xe=_("<div><!></div>");function $e(n,e){Y(e,!0);let a=O(e,"root",3,null),s=O(e,"top",3,0),o=O(e,"bottom",3,0),r=O(e,"increments",3,100),u=O(e,"value",15,void 0),g=[],w=[],l=[],i=[],t;function d(){let f=0,k=0;for(let T=0;T<g.length;T++)g[T]>f&&(f=g[T],k=T);f>0?u(k):u(void 0)}function S(f,k){const T=R=>{R[0].isIntersecting;const Q=R[0].intersectionRatio;g[k]=Q,d()},G=s()?s()*-1:0,N=o()?o()*-1:0,P=`${G}px 0px ${N}px 0px`,H={root:a(),rootMargin:P,threshold:w};i[k]&&i[k].disconnect();const L=new IntersectionObserver(T,H);L.observe(f),i[k]=L}function y(){l.length&&l.forEach(S)}V(()=>{for(let f=0;f<r()+1;f++)w.push(f/r());l=t.querySelectorAll(":scope > *:not(iframe)"),y()}),V(()=>{s(),o(),y()});var m=Xe(),A=v(m);me(A,()=>e.children??ie),p(m),Be(m,f=>t=f,()=>t),h(n,m),Z()}var ea=_('<div><p class="svelte-1sxgmm9"> </p></div>'),aa=_('<section id="scrolly"><h2 class="svelte-1sxgmm9">Scrolly <span> </span></h2> <div class="spacer svelte-1sxgmm9"></div> <!> <div class="spacer svelte-1sxgmm9"></div></section>');function ta(n){let e=W(void 0);var a=aa(),s=v(a),o=b(v(s)),r=v(o,!0);p(o),p(s);var u=b(s,4);$e(u,{get value(){return c(e)},set value(g){q(e,g,!0)},children:(g,w)=>{var l=E(),i=C(l);F(i,16,()=>[0,1,2,3,4],U,(t,d,S)=>{const y=j(()=>c(e)===S);var m=ea();let A;var f=v(m),k=v(f,!0);p(f),p(m),B(()=>{A=xe(m,1,"step svelte-1sxgmm9",null,A,{active:c(y)}),I(k,d)}),h(t,m)}),h(g,l)},$$slots:{default:!0}}),ke(2),p(a),B(()=>I(r,c(e)||"-")),h(n,a)}const na=`{
  "meta": {
